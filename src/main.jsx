...
const categoryColors = ['#1976d2', '#2e7d32', '#ed6c02', '#9c27b0', '#0288d1', '#d32f2f'];
...
const seed = {
  ...
  budget: 0,
  budgets: {},
  filters: { preset: 'month', month: '2026-07', from: '2026-07-01', to: '2026-07-31' },
  expenses: [],
  udhar: [],
};
...
function formatInr(value, locale = 'en') {
...
function signedInr(value, locale) {
...
function computeMetrics(state, scopedExpenses = state.expenses, month = getActiveBudgetMonth(state.filters)) {
...
function calculateClosing(balance, dueDate, interestRate) {
...
function filterExpensesByDate(expenses, filters = seed.filters) {
...
function buildReports(state, label, allExpenses = state.expenses, filters = seed.filters) {
